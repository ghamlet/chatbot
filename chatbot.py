...
#db = os.path.dirname(os.path.abspath(__file__)) + "/telegram.db"


bot = telebot.TeleBot('6037148486:AAFecH3CZhJXTZgijEWbS8jBSGfAbzpsOiI')
user_id=''
name = ''
surname = ''
age = 0
...
#     keyboard = bot.types.InlineKeyboardMarkup() #наша клавиатура
#     key_yes = bot.types.InlineKeyboardButton(text='Да', callback_data='yes') #кнопка «Да»
#     keyboard.add(key_yes) #добавляем кнопку в клавиатуру
#     key_no= bot.types.InlineKeyboardButton(text='Нет', callback_data='no')
#     keyboard.add(key_no)
